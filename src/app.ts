...
const teenTips = new Map<string, string>([
  ["hotel", "Prends le rôle de navigateur : hôtel enregistré, stations repérées, trajet retour compris. Le vrai test, c'est de rentrer sans panique après une grosse journée."],
  ["fireworks", "Mission anti-galère : vérifier l'emplacement officiel du feu, estimer la foule et choisir un plan de sortie. Si le retour semble infernal, skyline locale + dessert gagne."],
  ["gantry", "Objectif photo/vidéo : skyline, anciens portiques industriels et Pepsi-Cola sign en une mini-série. C'est LIC version carte postale, mais sans la foule de Manhattan."],
  ["times-square", "À faire comme un clip de 20 minutes : marches TKTS, écran le plus fou, flagship store préféré, puis extraction avant overdose de foule, bruit et mascottes."],
  ["bryant", "Mode reset : chaises libres, ombre, toilettes, recharge mentale. À toi de choisir si on repart vers architecture, shopping, dessert ou pause plus longue."],
  ["library", "Regarde ça comme un décor de film : lions, marbre, escaliers, salles silencieuses. Si la Rose Main Reading Room est accessible, c'est le plan Poudlard new-yorkais."],
  ["grand-central", "Chasse aux détails : plafond zodiacal peint à l'envers, horloge iconique, Whispering Gallery. Bonus si tu arrives à expliquer le 'bug acoustique' à quelqu'un."],
  ["rockefeller", "Repère les symboles : Prometheus, Channel Gardens, Radio City, façades art déco. Le but : trouver l'angle qui fait le plus scène de série new-yorkaise."],
  ["top-rock", "Choisis le cadrage final du voyage Midtown : Empire State plein axe, Central Park au nord, terrasse sans vitre au 70e. Téléphone chargé, stockage libre."],
  ["liberty", "À savoir avant la photo : la statue repose dans un ancien fort en étoile et la torche originale est au musée. Trouve l'angle le moins carte postale possible."],
  ["ellis", "Transforme la visite en enquête : un nom, une langue, un contrôle médical, une décision. Le Great Hall marche mieux si on imagine un vrai dossier d'arrivée."],
  ["wall-street", "À lire comme un décor de pouvoir : NYSE, Federal Hall, Trinity Church, Charging Bull si on passe. Mission : résumer pourquoi cette petite zone influence le monde."],
  ["oculus", "Spot vidéo parfait : symétrie, lignes blanches, foule, escalators. Fais un plan vertical qui donne l'impression d'entrer dans un vaisseau ou un jeu futuriste."],
  ["memorial911", "Ici, mission respect : pas de selfie, pas de blague. Observer les noms, l'eau, le Survivor Tree, et comprendre pourquoi le vide est le sujet du lieu."],
  ["brooklyn-bridge", "Traversée intelligente : trois arrêts photo max, eau à portée, côté Brooklyn en objectif. Le souvenir vient de la marche, pas de 40 photos identiques."],
  ["dumbo", "Washington Street est le cliché assumé ; essaie d'en faire une version moins standard. Pavés, pont, briques, cadrage bas : c'est presque un décor de cinéma."],
  ["carousel", "Même si le carrousel semble enfantin, l'objet date de 1922 et la verrière + skyline font un bon plan photo. Sinon, pause express au bord de l'eau."],
  ["bbpark", "Temps libre utile : choisir le meilleur banc, snack ou cadrage skyline. Si la lumière est bonne, c'est souvent plus fort que beaucoup d'observatoires payants."],
  ["central-park", "Choisis une vraie quête : Bow Bridge, Bethesda, The Mall ou Strawberry Fields. Sans objectif, Central Park devient juste 'on marche encore'."],
  ...
  ["chelsea-market", "Mission food court adulte : chacun shortlist deux options, on compare prix/queue/envie, puis vote. Point de rendez-vous obligatoire avant dispersion."],
  ["little-island", "Parc OVNI posé sur l'Hudson : tulipes en béton, chemins en hauteur, amphithéâtre. Bon spot pour redescendre après Chelsea sans s'enfermer."],
  ["moma-ps1", "À tester comme labo d'art, pas musée scolaire : si une oeuvre paraît bizarre, demande 'qu'est-ce que ça essaie de provoquer ?'. Si rien ne prend, sortie courte."],
  ["flushing", "Food crawl sérieux : bubble tea, dumplings, bakery, snacks de supermarché asiatique. Le score se joue sur la meilleure découverte, pas sur le monument."],
  ["astoria", "Soirée locale : pont Hell Gate, East River, dîner grec/méditerranéen. Mission : comparer ce New York de quartier avec Midtown ou Times Square."],
  ["soho", "Autonomie contrôlée : vitrines, sneakers, cast-iron, escaliers de secours. Choisis un micro-parcours de 20 minutes avec heure et point de ralliement précis."],
  ["chinatown", "Mission goût + ambiance : dumplings, bakery, bubble tea ou snack inconnu à partager. Bonus si tu trouves une adresse qui a l'air locale plutôt que pensée pour les touristes."],
  ["little-italy", "À voir comme une scène courte : Mulberry Street, enseignes, terrasses, dessert possible. Le plus intéressant, c'est la frontière avec Chinatown juste à côté."],
  ["washington-square", "Spot observation : NYU, arche, musiciens, échecs, skate, chiens, touristes. Mission : rester 10 minutes et raconter la meilleure micro-scène vue."],
  ["airport", "Dernière mission autonomie : passeport, chargeur, batterie, écouteurs, gourde vide, hoodie. Celui qui oublie un câble négocie avec le reste de l'équipe."],
]);
